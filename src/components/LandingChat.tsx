  ...
  return (
    ...
    >
      ...
      <div className="mb-14 text-center">
        <div className="flex items-baseline justify-center mb-3" style={{ fontWeight: 800, fontSize: 34, letterSpacing: '-.02em' }}>
      ...
      <div className="w-full max-w-2xl text-center mb-10">
        <h1 className="leading-tight mb-4" style={{ fontSize: 38, fontWeight: 800, letterSpacing: '-.025em', color: 'var(--lg-text)' }}>
      ...
      {/* Social proof */}
      <div className="mt-14 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm" style={{ color: 'var(--lg-text-dim)' }}>
