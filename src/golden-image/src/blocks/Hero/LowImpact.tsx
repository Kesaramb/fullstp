  ...
  return (
    <section className="bg-[var(--color-bg,#ffffff)] relative">
      <div className="site-container">
        <motion.div
          className="mx-auto max-w-3xl py-24 text-center md:py-32"
          {...fadeInUp}
        >
          {block.badge && (
          ...
          {block.subheading && (
            <p className="mx-auto max-w-xl text-lg md:text-xl text-[var(--color-text,#0f172a)]/65 leading-relaxed mb-10">
              {block.subheading}
            </p>
          )}
      ...
      <div className="site-container border-b border-[var(--color-border,#e2e8f0)]" />
    </section>
  )
}
