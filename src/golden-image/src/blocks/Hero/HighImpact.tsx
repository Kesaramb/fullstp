      ...
      >
        ...
        {block.ctaLabel && block.ctaLink && (
          <motion.div variants={staggerItem}>
            <a
              href={block.ctaLink}
              className="group inline-flex items-center gap-3 rounded-[var(--radius,0.5rem)] bg-white px-10 py-4.5 text-base font-semibold text-[var(--color-primary,#0f172a)] shadow-depth-lg transition-shadow transition-transform duration-300 hover:shadow-depth hover:-translate-y-1"
            >
              {block.ctaLabel}
