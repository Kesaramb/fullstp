    ...
    <section className="bg-[var(--color-bg-alt,#f8fafc)] py-24">
      <div className="site-container">
        <motion.div className="mx-auto max-w-lg" {...fadeInUp}>
          <div className="rounded-[var(--radius,0.5rem)] border border-[var(--color-border,#e2e8f0)] bg-white p-8 shadow-depth-sm md:p-10">
            {block.heading && (
