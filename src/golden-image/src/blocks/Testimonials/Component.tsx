...
export function TestimonialsBlock({ block }: TestimonialsProps) {
  ...
  return (
    <section className="bg-[var(--color-bg,#ffffff)] py-24 px-6 md:px-8 relative overflow-hidden">
      ...
      <motion.div className="relative z-10 mx-auto max-w-4xl" {...fadeInUp}>
          ...
          <div className="flex">
            {items.map((t, i) => (
              <div key={i} className="flex-[0_0_100%] min-w-0 px-4">
                <div className="mx-auto max-w-2xl rounded-[var(--radius,0.5rem)] border border-[var(--color-border,#e2e8f0)] bg-white p-8 md:p-12 shadow-depth-sm text-center">
                  <blockquote className="text-xl md:text-2xl leading-relaxed text-[var(--color-text,#0f172a)] mb-8 italic font-light">
                    &ldquo;{t.quote}&rdquo;
                  </blockquote>
