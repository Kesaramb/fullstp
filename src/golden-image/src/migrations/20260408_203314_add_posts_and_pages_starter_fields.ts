...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "footer" ALTER COLUMN "copyright" DROP DEFAULT;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "site_settings" ALTER COLUMN "theme_font_pairing" SET DATA TYPE text;
  ALTER TABLE "site_settings" ALTER COLUMN "theme_font_pairing" SET DEFAULT 'geist-inter'::text;
  ...
  ALTER TABLE "site_settings" ALTER COLUMN "theme_font_pairing" SET DEFAULT 'geist-inter'::"public"."enum_site_settings_theme_font_pairing";
  ALTER TABLE "site_settings" ALTER COLUMN "theme_font_pairing" SET DATA TYPE "public"."enum_site_settings_theme_font_pairing" USING "theme_font_pairing"::"public"."enum_site_settings_theme_font_pairing";
  ...
  ALTER TABLE "footer" ALTER COLUMN "copyright" SET DEFAULT '© 2026 All rights reserved.';
  ...
  ALTER TABLE "footer" DROP COLUMN "business_hours";
  ALTER TABLE "footer" DROP COLUMN "map_link";
